        ...
        <div class="bg-white w-full max-w-md p-8 rounded-2xl shadow-lg">
            <form action="{{ route('register') }}" method="POST" class="space-y-6">
                ...
                <div class="flex flex-col">
                    <label for="name" class="mb-2 text-gray-600 font-medium">Name</label>
                    <input 
                        type="text"
                        name="name"
                        value="{{ old('name') }}"
                ...
                <div class="flex flex-col">
                    <label for="password_confirmation" class="mb-2 text-gray-600 font-medium">Confirm Password</label>
                    <input 
                        type="password"
